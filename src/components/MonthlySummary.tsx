...
Adjunto el resumen de horas de servicio correspondientes al mes de ${monthName} de ${selectedYear} para ${consultantNameForEmail}.

Detalle de servicios:
${summaryText}

Total de horas facturables para el período: ${totalMonthHours.toFixed(2)} horas.
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div ref={printRef} className="print-view p-4">
          <h2 className="text-2xl font-semibold text-center text-slate-700 mb-2">
            Desglose de Horas {titleConsultantPart} - {monthName.charAt(0).toUpperCase() + monthName.slice(1)} {selectedYear}
          </h2>
